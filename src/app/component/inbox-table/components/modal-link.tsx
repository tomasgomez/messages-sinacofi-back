      ...
      >
        <Grid item xs={8}>
          ...
          <Typography
            ...
            fontSize={16}
          >
            {`${props.row.messageCode}`}{" "}
            <StyledCapitalizedSpan
              style={{ textTransform: "capitalize" }}
            >{`${props.row.description.toLowerCase()}`}</StyledCapitalizedSpan>
          </Typography>
        </Grid>
        ...
        <Box>
          ...
          <Grid container spacing={1}>
            <Grid item xs={2}>
              ...
              <StyledModalItem noWrap>13010</StyledModalItem>
            </Grid>
            <Grid item xs={2}>
              <Typography fontSize={"12px"}>Institución Destino</Typography>
              <StyledModalItem noWrap>0027 CORP BANCA</StyledModalItem>
            </Grid>
            <Grid item xs={2}>
              <Typography fontSize={"12px"}>Fecha</Typography>
              <StyledModalItem noWrap>14/02/2024</StyledModalItem>
            </Grid>
            <Grid item xs={2}>
              <Typography fontSize={"12px"}>Hora</Typography>
              <StyledModalItem noWrap>11:00:00</StyledModalItem>
            </Grid>
            <Grid item xs={2}>
          ...
          <Grid container width={"40%"} spacing={1} my={2}>
            ...
            <Grid item xs={6}>
              <Typography fontSize={"12px"}>
                Requiere Liquidación de Pre Pago
              </Typography>
              <StyledModalItem noWrap>Sí</StyledModalItem>
            </Grid>
            <Grid item xs={6}>
          ...
          <Grid container spacing={2} width={"66%"}>
            <Grid item xs={4}>
              ...
              >
                ...
                <Typography fontSize={14}>Pxxxxxx.doc</Typography>
      ...
      <Stack spacing={3}>
        ...
        <Box>
          <Grid container spacing={1}>
            ...
            <Grid item xs={2}>
              <Typography fontSize={"12px"}>Institución Destino</Typography>
              <StyledModalItem noWrap>0001 Banco de Chile</StyledModalItem>
            </Grid>
            <Grid item xs={2}>
              <Typography fontSize={"12px"}>Fecha</Typography>
              <StyledModalItem noWrap>{props.row.receivedDate}</StyledModalItem>
            </Grid>
            <Grid item xs={2}>
              <Typography fontSize={"12px"}>Hora</Typography>
              <StyledModalItem noWrap>{props.row.receivedTime}</StyledModalItem>
            </Grid>
            <Grid item xs={2}>
              <Typography fontSize={"12px"}>Prioridad</Typography>
              <StyledModalItem noWrap>
        ...
        <Box>
          ...
          <Grid container spacing={1}>
            <Grid item xs={2}>
              ...
              <StyledModalItem noWrap>Juan Pérez</StyledModalItem>
            </Grid>
            <Grid item xs={2}>
              <Typography fontSize={"12px"}>Cargo del Responsable</Typography>
              <StyledModalItem noWrap>Ejecutivo de Cuentas</StyledModalItem>
            </Grid>
            <Grid item xs={2}>
              <Typography fontSize={"12px"}>Teléfono</Typography>
              <StyledModalItem noWrap>+56 9 45623821</StyledModalItem>
            </Grid>
            <Grid item xs={2}>
              <Typography fontSize={"12px"}>No. de Referencia</Typography>
              <StyledModalItem noWrap>38DEAE3278173SDD</StyledModalItem>
            </Grid>
            <Grid item xs={2}>
            ...
            <Grid item xs={2}>
              ...
              <StyledModalItem noWrap>{"L (En Vivo)"}</StyledModalItem>
            </Grid>
          </Grid>
        </Box>
        <Typography fontSize={"12px"}>
          LA INSTITUCION EMISORA DEL MENSAJE ASUME LA TOTAL RESPONSABILIDAD
          AF3:POR EL CONTENIDO DE ESTE, EL CUAL SERA CONSIDERADO, EN CASO DE
          APROBACION, COMO DOCUMENTO OFICIAL DE ESTA INSTITUCION; EL BANCO
          CENTRAL DE CHILE NO TENDRA NINGUN TIPO DE RESPONSABILIDAD RESPECTO DE
          DICHO CONTENIDO Y LA TRANSACCION QUEDARA SUJETA A SU APROBACION.
        </Typography>
        <Grid container spacing={1}>
          <Grid item xs={2}>
            <Typography fontSize={"12px"}>BIC EMISOR</Typography>
            <StyledModalItem noWrap>CONBCLRM323</StyledModalItem>
          </Grid>
          <Grid item xs={2}>
          ...
          <Grid item xs={2}>
            ...
            <StyledModalItem noWrap>BSCHCLRM432</StyledModalItem>
          </Grid>
          <Grid item xs={2}>
            <Typography fontSize={"12px"}>Fecha de Emisión</Typography>
            <StyledModalItem noWrap>16 de enero de 2024</StyledModalItem>
          </Grid>
          <Grid item xs={2}>
            <Typography fontSize={"12px"}>
              {"Tipo de Moneda (ISO 4217)"}
            </Typography>
            <StyledModalItem noWrap>Peso Chileno CLP</StyledModalItem>
          </Grid>
          <Grid item xs={2}>
            <Typography fontSize={"12px"}>Monto de Operación</Typography>
            <StyledModalItem noWrap>$434,324.03</StyledModalItem>
          </Grid>
        </Grid>
        ...
        <Box>
          ...
          <Grid container spacing={2} my={1}>
            <Grid item xs={2}>
              ...
              <StyledModalItem noWrap>03/01/2024</StyledModalItem>
            </Grid>
            <Grid item xs={2}>
              <Typography fontSize={"12px"}>Canal</Typography>
              <StyledModalItem noWrap>Personas</StyledModalItem>
            </Grid>
            <Grid item xs={2}>
              <Typography fontSize={"12px"}>Tipo de Operación</Typography>
              <StyledModalItem noWrap>Mutuo con Compraventa</StyledModalItem>
            </Grid>
            <Grid item xs={2.5}>
          ...
          <Grid container width={"90%"} spacing={2}>
            <Grid item xs={2}>
              ...
              <StyledModalItem noWrap>Banco de Chile</StyledModalItem>
            </Grid>
            <Grid item xs={2}>
              <Typography fontSize={"12px"}>Vendedor</Typography>
              <StyledModalItem noWrap>Juan Perez Gonzalez</StyledModalItem>
            </Grid>
            <Grid item xs={2}>
              <Typography fontSize={"12px"}>RUT de Vendedor</Typography>
              <StyledModalItem noWrap>98.765.432-1</StyledModalItem>
            </Grid>
            <Grid item xs={2}>
              <Typography fontSize={"12px"}>Comprador</Typography>
              <StyledModalItem noWrap>Carolina Lopez Ruiz</StyledModalItem>
            </Grid>
            <Grid item xs={3}>
              <Typography fontSize={"12px"}>RUT de Comprador</Typography>
              <StyledModalItem noWrap>12.345.768-9</StyledModalItem>
            </Grid>
            <Grid item xs={2}>
              <Typography fontSize={"12px"}>Tipo de Inmueble</Typography>
              <StyledModalItem noWrap>Departamento</StyledModalItem>
            </Grid>
            <Grid item xs={5}>
              <Typography fontSize={"12px"}>
            ...
            <Grid item xs={2}>
              ...
              <StyledModalItem noWrap>Providencia</StyledModalItem>
            </Grid>
            <Grid item xs={2}>
              <Typography fontSize={"12px"}>Región</Typography>
              <StyledModalItem noWrap>Metropolitana, Santiago</StyledModalItem>
            </Grid>
            <Grid item xs={2}>
              <Typography fontSize={"12px"}>Institución</Typography>
              <StyledModalItem noWrap>Banco Internacional</StyledModalItem>
            </Grid>
            <Grid item xs={3}>
            ...
            <Grid item xs={2}>
              ...
              <StyledModalItem noWrap>3.259,59 UF</StyledModalItem>
            </Grid>
            <Grid item xs={2}>
              <Typography fontSize={"12px"}>{"Plazo (Años)"}</Typography>
              <StyledModalItem noWrap>20</StyledModalItem>
            </Grid>
            <Grid item xs={3}>
              <Typography fontSize={"12px"}>
                Monto del Mutuo Complementario
              </Typography>
              <StyledModalItem noWrap>540 UF</StyledModalItem>
            </Grid>
            <Grid item xs={2}>
              <Typography fontSize={"12px"}>Cargo Interno</Typography>
              <StyledModalItem noWrap>CRH 057 930480920</StyledModalItem>
            </Grid>
            <Grid item xs={2}>
            ...
            <Grid item xs={3}>
              ...
              <StyledModalItem noWrap>3.799,59 UF</StyledModalItem>
            </Grid>
          </Grid>
          ...
          <Grid container>
            ...
            <Grid xs={3}>
              ...
              <StyledModalItem noWrap>$5.000.000 CLP</StyledModalItem>
            </Grid>
          </Grid>
        </Box>
        <Grid container>
