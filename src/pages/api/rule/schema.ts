...
// import calls
import { getInstitutions } from '@/backend/handler/institution/get';
...
const institutionOptionsException = [
   ...
   { value: '729', label: '729 - LOS HEROES' },
   { value: '600', label: '600 - INKAS ETV' },
   { value: '732', label: '732 - TAPP' },
   { value: '730', label: '730 - TENPO SA' },
